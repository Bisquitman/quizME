...
const getData = () => {
  const dataBase = [
    {
      id: '01',
      theme: 'Тема 01. Финансовая грамотность',
      result: [
    ...
    {
      id: '02',
      theme: 'Тема 02. Фронтенд разработка',
      result: [
...
const renderQuiz = (quiz) => {
  ...
  const showQuestion = () => {
    ...
    fieldset.append(legend, ...answers); // ...answers - то же самое, что и answers[0], answers[1], ... , answers[n], где n заранее неизвестно
